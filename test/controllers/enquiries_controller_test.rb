...
class EnquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enquiry" do
    assert_difference("Enquiry.count") do
      post enquiries_url, params: { enquiry: { description: @enquiry.description, subject: @enquiry.subject } }
    end
  ...
  test "should update enquiry" do
    patch enquiry_url(@enquiry), params: { enquiry: { description: @enquiry.description, subject: @enquiry.subject } }
